...
%% Citation
% This supporting function was retrieved from the Matlab Central File
% Exchange, on which it is freely posted.

% Reference: Chad Greene, C2xyz contour matrix to coordinates
% (https://www.mathworks.com/matlabcentral/fileexchange/43162-c2xyz-contour-matrix-to-coordinates),
% MATLAB Central File Exchange. Version 1.2.1. Updated May 20, 2019.
